...
- [#10](https://github.com/coralogix/internal-staghorn/pull/10) [`7be6212`](https://github.com/coralogix/internal-staghorn/commit/7be6212a00b998c49602883bbdd914aaad2686f1) Thanks [@Knat-Dev](https://github.com/Knat-Dev)! - Implement `daemon.mode: 'external'`, make queries side-effect free, and prove the
  install layouts.
